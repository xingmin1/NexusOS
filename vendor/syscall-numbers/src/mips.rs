...
pub const SYS_process_mrelease: c_long = 0x1160;
pub const SYS_futex_waitv: c_long = 0x1161;
pub const SYS_set_mempolicy_home_node: c_long = 0x1162;
pub const SYS_cachestat: c_long = 0x1163;
pub const SYS_fchmodat2: c_long = 0x1164;
