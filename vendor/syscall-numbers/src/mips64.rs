...
pub const SYS_process_mrelease: c_long = 0x1548;
pub const SYS_futex_waitv: c_long = 0x1549;
pub const SYS_set_mempolicy_home_node: c_long = 0x154a;
pub const SYS_cachestat: c_long = 0x154b;
pub const SYS_fchmodat2: c_long = 0x154c;
