...
pub const SYS_process_mrelease: c_long = 0x1930;
pub const SYS_futex_waitv: c_long = 0x1931;
pub const SYS_set_mempolicy_home_node: c_long = 0x1932;
pub const SYS_cachestat: c_long = 0x1933;
pub const SYS_fchmodat2: c_long = 0x1934;
