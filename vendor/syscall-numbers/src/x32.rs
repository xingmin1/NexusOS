...
pub const SYS_memfd_secret: c_long = 0x400001bf;
pub const SYS_process_mrelease: c_long = 0x400001c0;
pub const SYS_futex_waitv: c_long = 0x400001c1;
pub const SYS_set_mempolicy_home_node: c_long = 0x400001c2;
pub const SYS_cachestat: c_long = 0x400001c3;
pub const SYS_fchmodat2: c_long = 0x400001c4;
